...
const SpAdvEventDetailsModal = (props: any) => {
      ...
      <Transition.Root show={open} as={Fragment}>
        ...
        >
          <div className="sm:block sm:p-0 flex items-end justify-center min-h-screen pt-4 pb-20 text-center">
            ...
            >
              <div className="sm:my-8 sm:align-middle sm:w-full lg:max-w-4xl shadow-info-modal border-cetaceanBlue-300 bg-antiFlashWhite-100  inline-block max-w-md max-h-full overflow-hidden text-left align-bottom transition-all transform">
                  ...
                  <div className="sm:mt-0 sm:text-left mt-3 text-center">
                    <Dialog.Title
                      style={{
                        ...
                        color: `#${props.item.hexColor}`,
                      }}
                      className=" font-spAdvSemiBold flex items-center justify-between px-5 py-4 text-sm font-semibold leading-5"
                    >
                      <p className="text-h2 font-spAdvSemiBold flex font-semibold leading-relaxed">
                        {props.item.title}
                      </p>
                      <div
                      ...
                      >
                        ...
                        >
                          <path
                            ...
                            fill={`#${props.item.hexColor}`}
                          />
                        </svg>
                      </div>
                    </Dialog.Title>
                    <div className="lg:px-8 text-neutral-400 py-6 text-sm font-normal">
                      <div className=" lg:px-8 text-neutral-400 font-spAdvRegular flex items-center my-10 text-base font-normal leading-6">
                        Date:{' '}
                        {moment(new Date(props.item.start)).format(
                          'DD-MM-YYYY h:mm a'
                        )}
                      </div>
                      <p className=" lg:px-8 text-neutral-400 font-spAdvRegular flex items-center my-10 text-base font-normal leading-6">
...
export default SpAdvEventDetailsModal;
