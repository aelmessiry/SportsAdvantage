...
import { carDecal } from '../../../../assets/images';
const SpAdvLargeCardModal = (props: any) => {
                  ...
                  <div className="sm:flex sm:items-start">
                    <div className="sm:mt-0 sm:text-left mt-3 text-center">
                      <Dialog.Title className=" font-spAdvSemiBold text-darkGunmetal-300 flex items-start justify-between py-4 text-sm font-semibold leading-5">
                        <div>
                          <p className="text-antiFlashWhite-100 text-h2 font-spAdvSemiBold flex font-semibold leading-relaxed">
                            {props.item.team}
                          </p>
                          <p className="text-neutral-400 flex text-base font-semibold leading-6">
                            {props.item.name}
                          </p>
                          <p className="text-antiFlashWhite-100 font-spAdvSemiBold flex text-xs font-semibold leading-5">
                            {props.item.site}
                          </p>
                        </div>
                        <div
                      ...
                      <div className="lg:px-8 text-neutral-400 py-6 text-sm font-normal">
                        <div className="mb-10">
                          ...
                          <div className=" text-neutral-400 font-spAdvBold text-lg font-bold leading-7">
                            Final approval for the decal is still pending. It
                        ...
                        <p className=" lg:px-8 text-neutral-400 font-spAdvRegular flex items-center justify-center my-10 text-base font-normal leading-6 text-center">
...
export default SpAdvLargeCardModal;
