...
export default function MainFilteration() {
    ...
    <div className="flex flex-wrap items-center w-full py-6 mx-auto">
      ...
      <div className="grow flex flex-wrap">
        ...
        <div className="lg:w-1/5 h-full p-4">
          <SpAdvSelect
            name="nationality"
            value={state.inputs.nationality}
            onChange={(selected: any) => handleChange(selected, 'nationality')}
            placeholder={'Nationality'}
            isSearchable={true}
            options={[
              { value: 'Nationality1', label: 'Nationality1' },
              { value: 'Nationality2', label: 'Nationality2' },
              { value: 'Nationality3', label: 'Nationality3' },
            ]}
          />
        </div>
        <div className="lg:w-1/5 h-full p-4">
