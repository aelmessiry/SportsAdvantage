              ...
              <div className="bg-cetaceanBlue-100px-14 sm:pb-4 py-6">
                <div className="sm:flex sm:items-start w-full">
                  <div className="sm:mt-0 sm:text-left w-full mt-3 text-center">
                    ...
                    <Dialog.Panel>
                      <Dialog.Description>
                        <p className="m-5 text-white text-h4">
                          Your wallet is encyrpted with password, please enter
                          your password
                        </p>
                      </Dialog.Description>
                      ...
                      <form onsubmit={handleSubmit} className="p-5">
                        <div class="form-group" id="formPassword">
                          <input
                            ...
                            className="bg-antiFlashWhite-400 rounded-2xl text-darkGunmetal-300  py-3 w-80 border-none"
                          />
                        </div>
                      </form>
                      <div className="flex justify-center align-baseline mt-10">
                        ...
                        <SpAdvButton onClick={handleSubmit}>
                          <span>Submit</span>
                        </SpAdvButton>
                      </div>
                    </Dialog.Panel>
