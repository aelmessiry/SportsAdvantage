                ...
                <div className="sm:flex sm:items-start w-full">
                  <div className="sm:mt-0 sm:text-left w-full mt-3 text-center">
                    <Dialog.Title className=" border-b-neutral-1100 font-spAdvSemiBold text-darkGunmetal-300 relative flex items-start py-2 text-sm font-semibold leading-5 border-b">
                      ...
                      <div
                        className="bg-cetaceanBlue-500 border-lava-100 right-2 lg:p-2 md:p-1 p-0 absolute border cursor-pointer"
                        onClick={() => {
                          setOpen(false);
                          props.close();
                        }}
                    ...
                    <Dialog.Panel>
                      <p className="p-4 text-white">
                        Entering a password encrypts your wallet, however, we
                        will not be able of restoring your account if you lose
                        the password.
                      </p>
                      <form onsubmit={handleSubmit} className="p-5">
                        <div className="form-group" id="formPassword">
                          <input
                            ...
                            className="bg-antiFlashWhite-400 rounded-2xl text-darkGunmetal-300 w-80 py-3 border-none"
                          />
                        </div>
                        <br />
                        ...
                        {!passwordsMatch && (
                          <div className="text-lava-100 text-lg">
                      ...
                      <div>
                        ...
                        <div className="flex items-center px-8">
                          <input
                            ...
                            onChange={() =>
                              handleCheckboxChange('privacyPolicyAgreed')
                            }
                            className="focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded"
                          />
                          <label
                      ...
                      <div className="flex flex-wrap justify-center mt-10 align-baseline">
                        <SpAdvButton
                          className={`${
                            isAgreementAccept()
                              ? '!bg-green-600'
                              : '!bg-neutral-300 pointer-event-none'
                          } mr-8`}
                          onClick={handleWithoutPassword}
                          disabled={!isAgreementAccept()}
                        >
                          <span>No thank you, without a password!</span>
                        </SpAdvButton>
                        <SpAdvButton
                          onClick={handleSubmit}
                          disabled={!isAgreementAccept()}
                          className={'lg:mt-0 md:mt-0 mt-2'}
                        >
                          {loading ? (
